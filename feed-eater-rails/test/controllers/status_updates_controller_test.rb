...
class StatusUpdatesControllerTest < ActionController::TestCase
  ...
  test "should create status_update" do
    assert_difference('StatusUpdate.count') do
      post :create, status_update: { action: @status_update.action, glue: @status_update.glue, status: @status_update.status, user: @status_update.user }
    end
  ...
  test "should update status_update" do
    patch :update, id: @status_update, status_update: { action: @status_update.action, glue: @status_update.glue, status: @status_update.status, user: @status_update.user }
    assert_redirected_to status_update_path(assigns(:status_update))
  end
